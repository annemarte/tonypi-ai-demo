            ...
            input=[
                {
                    ...
                    "content": (
                        ...
                        "person svært nær roboten, et ansikt som fyller store "
                        "deler av bildet eller virker rett oppi kameraet, eller "
                        "utilstrekkelig/uklar informasjon. Ved usikkerhet skal du "
                        "ALLTID anta at det IKKE er trygt. "
